        ...
        <div className="flex flex-1 items-center justify-center p-12">
          <div className="relative h-96 w-full max-w-md">
            ...
            <div className="absolute -bottom-4 left-1/2 max-w-sm -translate-x-1/2 transform rounded-2xl bg-white p-6 shadow-2xl">
              <div className="mb-3 text-3xl text-blue-500">&ldquo;</div>
      ...
      <div className="flex flex-1 items-center justify-center bg-black p-8">
        <div className="w-full max-w-md">
          ...
          <button
            ...
            className="flex w-full cursor-pointer items-center justify-center gap-3 rounded-xl bg-white px-4 py-3 font-medium text-zinc-800 shadow-md shadow-white/5 transition-all duration-200 hover:bg-zinc-100 active:scale-[0.98]"
          >
