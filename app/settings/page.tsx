                    ...
                    return (
                      ...
                      >
                        ...
                        <input
                          ...
                          className="ml-7 mt-2 w-[calc(100%-1.75rem)] rounded-lg border border-[var(--border)] bg-zinc-800/50 px-3 py-2 text-sm text-[var(--text-secondary)] placeholder-[var(--text-muted)] transition-colors focus:border-[var(--accent)] focus:bg-[var(--bg-elevated)] focus:outline-none"
                        />
                      </div>
                    );
                  })}
